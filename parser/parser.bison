...
%type <expr> opt_expr expr_list non_empty_expr_list expr assignment_expr logical_expr comparison_expr add_expr mult_expr exponent factor pre_post_incr primary_expr integer string char ident
...
logical_expr : logical_expr TOKEN_LOGICAL_AND comparison_expr
	...
	| logical_expr TOKEN_LOGICAL_OR comparison_expr
...
primary_expr : ident
	...
	| ident TOKEN_LBRACKET expr_list TOKEN_RBRACKET
		{ $$ = expr_create(EXPR_ARRINDEX, $1, $3); }
	;
