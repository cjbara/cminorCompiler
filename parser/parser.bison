...
%type <expr> opt_expr expr_list non_empty_expr_list expr assignment_expr logical_or_expr logical_and_expr equality_expr comparison_expr add_expr mult_expr exponent factor pre_post_incr primary_expr integer string char ident non_empty_array_index array_index
...
decl	: ident TOKEN_COLON type TOKEN_SEMICOLON
	...
	| ident TOKEN_COLON type_array TOKEN_ASSIGNMENT TOKEN_LCURLY expr_list TOKEN_RCURLY TOKEN_SEMICOLON
		{ $$ = decl_create($1->name, $3, expr_create(EXPR_BLOCK, 0, $6), 0); }
	;
...
primary_expr : ident
	...
	| char
		{ $$ = $1; }
	| TOKEN_TRUE
		{ $$ = expr_create(EXPR_TRUE, 0, 0); }
	| TOKEN_FALSE
		{ $$ = expr_create(EXPR_FALSE, 0, 0); }
...
non_empty_array_index : TOKEN_LBRACKET expr_list TOKEN_RBRACKET array_index
		{ $$ = expr_create(EXPR_ARRINDEX, $2, $4); }
	;

array_index : TOKEN_LBRACKET expr_list TOKEN_RBRACKET array_index
		{ $$ = expr_create(EXPR_ARRINDEX, $2, $4); }
	| /* nothing */
		{ $$ = 0; }
	;
